<template>
  <div class="container">
      ...
      <table class="table">
        ...
        <tr v-for="(subject, index) in subjects" v-bind:key="subject.subjectId">
          ...
          <td>
            ...
            <button class="btn btn-primary" v-on:click="editSubject=subject.subjectId" style="margin-right: 5px"><b-icon-pencil/> Edit</button>
            <button class="btn btn-danger" v-on:click="deleteSubject(subject)"><b-icon-trash/> Delete</button>
          </td>
        </tr>
        </tbody>
      </table>
    ...
    <div>
      <button class="btn btn-primary" style="display: flex" v-on:click="addSubjectPage"><b-icon-plus/> Add new</button>
    </div>
  </div>
</template>
