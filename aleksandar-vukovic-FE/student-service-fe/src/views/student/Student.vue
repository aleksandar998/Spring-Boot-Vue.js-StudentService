<template>
  <div class="container">
    ...
    <table class="table">
      ...
      <tr v-for="(student, index) in students" v-bind:key="student.studentId">
        ...
        <td>
          <div v-if="editStudent===student.studentId">
            <form class="form-update">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-10">
                  <input type="number" class="form-control" id="currentYearOfStudy"
          ...
          <button class="btn btn-primary" v-on:click="editStudent=student.studentId" style="margin-right: 5px">
            <b-icon-pencil/>
            Edit
          </button>
    ...
    <div class="buttons">
      <button class="btn btn-primary" v-on:click="addStudentPage" style="margin-right: 950px;">
        <b-icon-plus/>
        Add new
      </button>
      <button class="btn btn-primary" v-on:click="addRegistration">
        <b-icon-plus/>
